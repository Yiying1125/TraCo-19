...
import mmu.edu.my.traco_19.Activities.LocationHistory;
import mmu.edu.my.traco_19.Classes.PlacesClass;
import mmu.edu.my.traco_19.R;

import static mmu.edu.my.traco_19.Activities.LocationHistory.colour;

public class PlacesAdapter extends ArrayAdapter<PlacesClass> {
    Context mContext;
    int mResource;
    ArrayList<View> all = new ArrayList<>(20);
